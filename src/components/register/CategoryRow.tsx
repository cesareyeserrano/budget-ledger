              ...
              {categories.map((c) => {
                ...
                return (
                  <button
                    ...
                    className="flex min-h-(--control-lg) min-w-[64px] shrink-0 flex-col items-center gap-1 rounded-(--radius-md) border px-3 py-2 transition-all duration-(--duration-normal)"
              ...
              {expandedSubs.map((s) => {
                ...
                return (
                  <button
                    ...
                    className="flex min-h-(--control-md) shrink-0 items-center gap-1 rounded-(--radius-sm) border px-3 py-1.5 text-xs transition-all duration-(--duration-normal)"
