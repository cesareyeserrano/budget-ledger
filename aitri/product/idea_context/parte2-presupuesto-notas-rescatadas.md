# Parte 2 — Notas de dominio (presupuesto + jerarquía de categorías)

## A) Jerarquía de categorías gestionable 
...
### Grupo: Transferencias (= "ahorro / dos disponibles")
...
- Cada celda tiene dos orígenes:
  ...
  - **Ejecutado:** llega **automáticamente** desde el registro de movimientos, que principalmente serpa la vista mobile, agregados por categoría/mes.
  - El ejecutado tambien se pueda **editar manualmente** (override) en la grilla
...
- **Mobile (resumida):**
  - Modulo de regustr de movimientos
